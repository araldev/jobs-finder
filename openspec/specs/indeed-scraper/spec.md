...
> **PROMOTED to source of truth on 2026-06-13** from
> `openspec/changes/scheduler-source-fix/specs/indeed-scraper/spec.md`.
>
> This is the foundational spec for the `indeed-scraper`
> capability, capturing the `IndeedPlaywrightScraper`, its URL
> formula, pagination, blocking detection, and the `source`
> field extension from `scheduler-source-fix`. Source
> observation IDs for traceability: proposal #412, spec #413,
> design #414, tasks #415, apply-progress #416, verify-report
> #417.
...
### REQ-SOURCE-002 — Indeed scraper sets source="indeed" on Job construction
...
### REQ-QUERY-003 — Indeed scraper handles empty keywords without error
...
| REQ | Scenarios | Count |
|-----|-----------|-------|
| REQ-SOURCE-002 | Indeed sets source, source is testable | 2 |
| REQ-QUERY-003 | Empty keywords passed to URL builder as-is | 1 |
| **Total** | | **3** |
