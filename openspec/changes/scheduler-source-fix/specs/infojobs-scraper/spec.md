# Delta for `infojobs-scraper`

## ADDED Requirements

### Requirement: REQ-SOURCE-002 — InfoJobs scraper sets source="infojobs" on Job construction
...
### Requirement: REQ-QUERY-003 — InfoJobs scraper handles empty keywords without error
